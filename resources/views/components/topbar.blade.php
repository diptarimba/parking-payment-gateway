        ...
        <div class="d-flex align-items-center">
          ...
          <form class="navbar-search form-inline" id="navbar-search-main">
            <div class="input-group input-group-merge search-bar">
                ...
                <input class="input-group-text form-control" list="datalistOptions" onfocus="this.value=''" onchange="this.blur();" id="cariLocation" placeholder="Type to search...">
        ...
        <ul class="navbar-nav align-items-center">
          ...
          <li class="nav-item dropdown ms-lg-3">
            ...
            <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
              ...
              <a class="dropdown-item d-flex align-items-center" href="{{route('logout.index')}}">
